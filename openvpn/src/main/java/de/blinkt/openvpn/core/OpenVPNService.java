...
import de.blinkt.openvpn.Constant;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
        ...
        try {
            if (mNotificationActivityClass != null) {
                ...
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) {
                    pIntent = PendingIntent.getActivity(this, 0, intent, Constant. PENDING_INTENT_FLAG);
    ...
    private void addVpnActionsToNotification(Notification.Builder nbuilder) {
        ...
        if (mDeviceStateReceiver == null || !mDeviceStateReceiver.isUserPaused()) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) {
                pauseVPNPending = PendingIntent.getActivity(this, 0, pauseVPN, PendingIntent.FLAG_MUTABLE);
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) {
                resumeVPNPending = PendingIntent.getActivity(this, 0, pauseVPN, PendingIntent.FLAG_MUTABLE);
    ...
    PendingIntent getUserInputIntent(String needed) {
        ...
        PendingIntent pIntent;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) {
            pIntent = PendingIntent.getActivity(this, 12, intent, PendingIntent.FLAG_MUTABLE);
    ...
    PendingIntent getGraphPendingIntent() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) {
            startLW = PendingIntent.getActivity(this, 0, intent, Constant.PENDING_INTENT_FLAG);
